...
dHigh = designfilt('highpassfir','PassbandFrequency',300000, ...
    ...
    for i = 1:length(Files)
        ...
        if 0 %S.data.failed
            ...
            for k = 1:n_positions 
                all_data(count).raw_xdr_1 = S.data.tx_data(:, :, k);
               
                all_data(count).raw_xdr_2 = S.data.rx_data(:, :, k);
                ...
                all_data(count).filt_xdr_1 = S.data.tx_data(:,:,k);
                all_data(count).filt_xdr_2 = S.data.rx_data(:,:,k);
